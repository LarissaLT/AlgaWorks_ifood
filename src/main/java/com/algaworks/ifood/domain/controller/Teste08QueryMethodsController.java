...
@RestController
@RequestMapping("/teste-08")
public class Teste08QueryMethodsController {
    @Autowired
    private RestauranteRepository restauranteRepository;

    @GetMapping("/restaurantes/por-nome-id")
    public List<Restaurante> consultarRestaurantePorNomeEIddaCozinha(
            String nome, @RequestParam("maritaca") Long cozinhaId) {
        return restauranteRepository.findByNomeContainingAndCozinhaId(nome, cozinhaId);
    }
}


    //@RequestParam para dar nome ao parâmetro